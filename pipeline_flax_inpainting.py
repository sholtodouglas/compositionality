...
from converted_torch_fns import prepare_mask_and_masked_image, prepare_mask_latents


logger = logging.get_logger(__name__)  # pylint: disable=invalid-name


class FlaxInpaintingStableDiffusionPipeline(FlaxDiffusionPipeline):
    r"""
    ...
    def _generate(
        ...
        image: Union[jax.Array, PIL.Image.Image],
        mask_image: Union[jax.Array, PIL.Image.Image],
        params: Union[Dict, FrozenDict],
        prng_seed: Callable[[int], jax.random.KeyArray],
        ...
        def loop_body(step, args):
            ...
            latents_input = jnp.concatenate([latents_input, mask, masked_image_latents], axis=1)
